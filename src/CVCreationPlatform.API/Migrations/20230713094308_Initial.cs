        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TemplateName = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    CssClassName = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResumeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    InstituteName = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    Degree = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
                    FieldOfStudy = table.Column<string>(type: "varchar(max)", unicode: false, nullable: true),
